...
DMG_OUTPUT="$PROJECT_DIR/IQspeakr-v4-Installer.dmg"

echo "▸ Erstelle IQspeakr v4 Installer..."
...
# Resources: v4-App-Dateien (werden bei Installation nach ~/.iqspeakr kopiert)
# Abweichung zu v1: Quellen liegen direkt im macos_v4/-Root, nicht in installer/
...
# Icon: v4 liefert IQspeakr.icns mit — wird sowohl fuer Installer als auch
...
echo ""
echo "╔══════════════════════════════════════════════╗"
echo "║  IQspeakr-v4-Installer.dmg ist bereit!       ║"
echo "║                                              ║"
