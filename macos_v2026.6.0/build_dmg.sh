#!/usr/bin/env bash
# ============================================================
#  IQspeakr v2026.6.7 — DMG Builder
...
DMG_OUTPUT="$PROJECT_DIR/IQspeakr-v2026.6.7-Installer.dmg"

echo "▸ Erstelle IQspeakr v2026.6.7 Installer..."
...
hdiutil create \
    -volname "IQspeakr v2026.6.7 Installer" \
...
echo ""
echo "╔══════════════════════════════════════════════╗"
echo "║  IQspeakr-v2026.6.7-Installer.dmg ist bereit!       ║"
echo "║                                              ║"
