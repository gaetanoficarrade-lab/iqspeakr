#!/usr/bin/env bash
# ============================================================
#  IQspeakr v2026.6.0 — DMG Builder
...
DMG_OUTPUT="$PROJECT_DIR/IQspeakr-v2026.6.0-Installer.dmg"

echo "▸ Erstelle IQspeakr v2026.6.0 Installer..."
...
hdiutil create \
    -volname "IQspeakr v2026.6.0 Installer" \
...
echo ""
echo "╔══════════════════════════════════════════════╗"
echo "║  IQspeakr-v2026.6.0-Installer.dmg ist bereit!       ║"
echo "║                                              ║"
