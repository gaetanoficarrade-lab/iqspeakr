#!/usr/bin/env bash
# ============================================================
#  IQspeakr v2026.6.5 — DMG Builder
...
DMG_OUTPUT="$PROJECT_DIR/IQspeakr-v2026.6.5-Installer.dmg"

echo "▸ Erstelle IQspeakr v2026.6.5 Installer..."
...
hdiutil create \
    -volname "IQspeakr v2026.6.5 Installer" \
...
echo ""
echo "╔══════════════════════════════════════════════╗"
echo "║  IQspeakr-v2026.6.5-Installer.dmg ist bereit!       ║"
echo "║                                              ║"
