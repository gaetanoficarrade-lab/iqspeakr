#!/usr/bin/env bash
# ============================================================
#  IQspeakr v2026.6.4 — DMG Builder
...
DMG_OUTPUT="$PROJECT_DIR/IQspeakr-v2026.6.4-Installer.dmg"

echo "▸ Erstelle IQspeakr v2026.6.4 Installer..."
...
hdiutil create \
    -volname "IQspeakr v2026.6.4 Installer" \
...
echo ""
echo "╔══════════════════════════════════════════════╗"
echo "║  IQspeakr-v2026.6.4-Installer.dmg ist bereit!       ║"
echo "║                                              ║"
