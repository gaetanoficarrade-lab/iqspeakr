...
DMG_OUTPUT="$PROJECT_DIR/IQspeakr-v6-Installer.dmg"

echo "▸ Erstelle IQspeakr v6 Installer..."
...
# Resources: v6-App-Dateien (werden bei Installation nach ~/.iqspeakr kopiert)
# Abweichung zu v1: Quellen liegen direkt im macos_v6/-Root, nicht in installer/
...
# absoluten Build-Pfade (z.B. /Users/.../macos_v6/launcher.c) im Mach-O
...
# Icon: v6 liefert IQspeakr.icns mit — wird sowohl fuer Installer als auch
...
echo ""
echo "╔══════════════════════════════════════════════╗"
echo "║  IQspeakr-v6-Installer.dmg ist bereit!       ║"
echo "║                                              ║"
