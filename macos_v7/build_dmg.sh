...
DMG_OUTPUT="$PROJECT_DIR/IQspeakr-v7-Installer.dmg"

echo "▸ Erstelle IQspeakr v7 Installer..."
...
# Resources: v7-App-Dateien (werden bei Installation nach ~/.iqspeakr kopiert)
# Abweichung zu v1: Quellen liegen direkt im macos_v7/-Root, nicht in installer/
...
# absoluten Build-Pfade (z.B. /Users/.../macos_v7/launcher.c) im Mach-O
...
# Icon: v7 liefert IQspeakr.icns mit — wird sowohl fuer Installer als auch
...
echo ""
echo "╔══════════════════════════════════════════════╗"
echo "║  IQspeakr-v7-Installer.dmg ist bereit!       ║"
echo "║                                              ║"
